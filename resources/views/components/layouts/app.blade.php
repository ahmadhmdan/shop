    ...
    <nav class="navbar navbar-expand-xl">
        <div class="container">
            ...
            <a class="navbar-brand">
                <img class="light-mode-item navbar-brand-item" src="assets/images/logo.svg" alt="logo" style="width: 120px;">
                <img class="dark-mode-item navbar-brand-item" src="assets/images/logo-light.svg" alt="logo" style="width: 120px;">
            </a>
            <!-- Logo END -->
                        ...
                        <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                            ...
                            <li class="px-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <a class="h6 mt-2 mt-sm-0" href="{{ route('dashboard') }}">{{ Auth::user()->name }}</a>
                            ...
                            <!-- Links -->
                            <li><a class="dropdown-item" href="{{ route('dashboard') }}"><i class="bi bi-person fa-fw me-2"></i>dashboard</a></li>
                            <li><a class="dropdown-item" href="{{ route('profile.show') }}"><i class="bi bi-person fa-fw me-2"></i>Edit Profile</a></li>
            ...
            <div class="navbar-nav d-none d-lg-inline-block">
                <a href="{{ route('register') }}" class="me-2">

        ...
        <div class="container pt-5 mt-0 mt-lg-5">
            ...
            <div class="row position-relative mb-0 mb-sm-5 pb-0 pb-lg-5">
                <div class="col-lg-8 text-center mx-auto position-relative">
                    ...
                    <!-- Title -->
                    <h2>Empower Your Shopping Experience: Discover, Shop, and Elevate Your Lifestyle.</h2>
                    ...
                    <div class="col-md-8 text-center mx-auto pb-5">
                        <form class="bg-body shadow rounded p-2">
                            <div class="input-group">
                                <input class="form-control border-0 me-1" type="search" placeholder="Find your product">
...
Featured product START -->
    <section class="pt-0 pt-md-5">
        <div class="container">
            <!-- Filtering Form -->
            <form wire:submit.prevent="filterProducts" class="col-md-8 mx-auto">
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select wire:model="selectedCategory" id="category" class="form-select">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check">
                            <input wire:model="selectedPriceRange" class="form-check-input" type="radio" name="priceRange" id="all" value="all" checked>
                            <label class="form-check-label" for="all">All Prices</label>
                        </div>
                        <div class="form-check">
                            <input wire:model="selectedPriceRange" class="form-check-input" type="radio" name="priceRange" id="low" value="low">
                            <label class="form-check-label" for="low">Low to High</label>
                        </div>
                        <div class="form-check">
                            <input wire:model="selectedPriceRange" class="form-check-input" type="radio" name="priceRange" id="high" value="high">
            ...
            <div class="row g-4">
                    ...
                    <div class="card p-2 shadow h-100">
                        <div class="rounded-top overflow-hidden">
                            <div class="card-overlay-hover">
                                <!-- Image -->
                                <img src="{{ asset('storage/' . ($product->image ?? 'assets/images/courses/4by3/17.jpg')) }}" class="card-img-top" alt="{{ $product->name }} Image">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-0">
                                <div><a href="#" class="badge bg-info bg-opacity-10 text-info me-2"><i class="fas fa-circle small fw-bold"></i> {{ $product->category->name }} </a></div>
                                <!-- Price -->
                ...
                <div class="col-12 text-center my-5">
                    <p class="lead">No products found, Please add some product in the admin panel.</p>
                </div>
                @endif
                <!-- Card Item END -->
                        ...
                        <div class="row justify-content-center position-relative">
                            ...
                            <div class="col-11 position-relative">
                                <div class="row align-items-center">
                                    <!-- Title -->
                                    <div class="col-lg-7">
                                        <h3 class="text-white mb-0">Create your first online shop</h3>
                                        <!-- List -->
